  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url(images/others/under-construction-banner.jpg)",
        }}
      >
              ...
              <div className="under-construction-inner-content">
                ...
                <div className="newsletter-content">
                  <div className="text-left">
                    ...
                    <p className="m-b-xs-20">
                      Be the first to know when we launch.
                      <br />
                      Sign up for this website updates using the form below.
                    </p>
                  </div>
                  ...
                  <div className="subscription-form-wrapper">
                    <form
                      action="#"
                      className="subscription-form row no-gutters"
                    >
                      <FormGroup
                        pClass="m-b-xs-20 col-auto"
